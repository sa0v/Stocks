...
# Calculate the most recent date of the record
...
ggplot(predicted_30_days_df, aes(x = Date, y = PredictedPrice)) +
  ...
  labs(
    title = str_wrap(glue::glue("Predicted Stock Prices for Next 30 Days with Buy/Hold/Sell Indicators ({stock_symbol}, USD) (Last Updated on {most_recent_date})"), width = 50),
    subtitle = glue::glue(
