...
retry_time <- 10   # Initial retry time in seconds

# Function to get stock data with retry mechanism
get_stock_data <- function(symbol, max_retries = 10, retry_time = 10) {
  for (attempt in 1:max_retries) {
    ...
    tryCatch({
      ...
      if (attempt < max_retries) {
        ...
        retry_time <<- retry_time + 10  # Increase retry time by 10 seconds for next attempt (use <<- to update the global variable)
      } else {
